...
class OrderHistoryPage extends BasePage {
  OrderHistoryPage({Key? key}) : super(key: key, bloc: OrderHistoryBloc());
...
class _OrderHistoryPageState extends BasePageState<OrderHistoryPage, BaseBloc> {
  ...
  Widget buildWidget(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(S.current.menu_history),
        centerTitle: true,
        elevation: 1,
        actions: [
          Padding(
