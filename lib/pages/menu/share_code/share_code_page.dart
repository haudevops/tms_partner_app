...
class ShareCodePage extends BasePage {
  const ShareCodePage({required this.data});

  static const routeName = '/ShareCodePage';
  final ScreenArguments data;

  @override
  State<StatefulWidget> createState() => _ShareCodePageState();
}

class _ShareCodePageState extends BasePageState<ShareCodePage, BaseBloc> {
  String? _phone;
  ...
  Widget buildWidget(BuildContext context) {
    return Scaffold(
      appBar: AppBarCustom(
        titleWidget: Text(S.current.share),
        showOnBack: true,
      ),
      body: Column(
        children: [
